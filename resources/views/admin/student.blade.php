                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/store') }}" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <input name="class_id" type="text" class="form-control"  placeholder="Enter class ID">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Student ID</label>
                                <input value="{{ $student->student_id }}" name="student_id" type="text" class="form-control"  placeholder="Enter student ID">
                            </div>

                            <div class="form-group">
                              <label>Class ID</label>
                              <input value="{{ $student->class_id }}" name="class_id" type="text" class="form-control"  placeholder="Enter class ID">
                            </div>
